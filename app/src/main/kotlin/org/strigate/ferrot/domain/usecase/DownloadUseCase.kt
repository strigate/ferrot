...
import org.strigate.ferrot.domain.usecase.download.UpdateDownloadCookieSetUseCase
...
import org.strigate.ferrot.domain.usecase.download.UpdateDownloadsArchivedUseCase
...
class DownloadUseCase @Inject constructor(
    ...
    val updateDownloadsArchivedUseCase: UpdateDownloadsArchivedUseCase,
    ...
    val updateDownloadCookieSetUseCase: UpdateDownloadCookieSetUseCase,
