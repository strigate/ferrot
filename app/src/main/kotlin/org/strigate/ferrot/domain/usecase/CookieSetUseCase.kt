...
import org.strigate.ferrot.domain.usecase.cookieset.GetCookieSetByIdWithDomainsUseCase
import org.strigate.ferrot.domain.usecase.cookieset.GetCookieSetCookiesTextUseCase
...
class CookieSetUseCase @Inject constructor(
    ...
    val getCookieSetByIdWithDomainsUseCase: GetCookieSetByIdWithDomainsUseCase,
    val getCookieSetCookiesTextUseCase: GetCookieSetCookiesTextUseCase,
