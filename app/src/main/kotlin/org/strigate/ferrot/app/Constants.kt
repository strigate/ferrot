...
object Constants {
    ...
    object Work {
        object Name {
            ...
            const val ONETIME_DELETE_DUPLICATE_DOWNLOADS =
                "$ONETIME.DELETE_DUPLICATE_DOWNLOADS"
            const val ONETIME_DELETE_ORPHAN_DOWNLOAD_FILES =
                "$ONETIME.DELETE_ORPHAN_DOWNLOAD_FILES"

            const val PERIODIC_DOWNLOAD_AVAILABLE_UPDATE_FIRST =
                "$PERIODIC.DOWNLOAD_AVAILABLE_UPDATE_FIRST"
            const val PERIODIC_DOWNLOAD_AVAILABLE_UPDATE_SECOND =
                "$PERIODIC.DOWNLOAD_AVAILABLE_UPDATE_SECOND"
            const val PERIODIC_UPDATE_DEPENDENCIES =
                "$PERIODIC.UPDATE_DEPENDENCIES"
            const val PERIODIC_DELETE_DUPLICATE_DOWNLOADS =
                "$PERIODIC.DELETE_DUPLICATE_DOWNLOADS"
            const val PERIODIC_DELETE_ORPHAN_DOWNLOADS =
    ...
    object Action {
        ...
        const val ACTION_AVAILABLE_UPDATE_NOTIFICATION = "$ACTION.AVAILABLE_UPDATE_NOTIFICATION"
        ...
        const val ACTION_NAVIGATE_DOWNLOADS = "$ACTION.NAVIGATE_DOWNLOADS"
