...
object Constants {
    ...
    object Work {
        object Name {
            ...
            const val ONETIME_DELETE_DOWNLOADS = "$ONETIME.DELETE_DOWNLOADS"
            const val ONETIME_DELETE_DUPLICATE_DOWNLOADS = "$ONETIME.DELETE_DUPLICATE_DOWNLOADS"
            const val ONETIME_DELETE_ORPHAN_DOWNLOAD_FILES = "$ONETIME.DELETE_ORPHAN_DOWNLOAD_FILES"
            ...
            const val PERIODIC_DELETE_DUPLICATE_DOWNLOADS = "$PERIODIC.DELETE_DUPLICATE_DOWNLOADS"
            const val PERIODIC_DELETE_ORPHAN_DOWNLOADS = "$PERIODIC.DELETE_ORPHAN_DOWNLOAD_FILES"
